...
describe("Map2", () => {
    it("should has()", () => {
        expect(new BiMap([["a", "b", 2], ["b", "c", 3]]).has("a", "b")).toEqual(true);
        expect(new BiMap([["a", "b", 2], ["b", "c", 3]]).has("a", "c")).toEqual(false);
    });

    it("should get()", () => {
        expect(new BiMap([["a", "b", 2], ["b", "c", 3]]).get("a", "b")).toEqual(2);
        expect(new BiMap([["a", "b", 2], ["b", "c", 3]]).get("a", "c")).toEqual(undefined);
    });

    it("should getOrDefault()", () => {
        expect(new BiMap([["a", "b", 2], ["b", "c", 3]]).getOrDefault("a", "b", 0)).toEqual(2);
        expect(new BiMap([["a", "b", 2], ["b", "c", 3]]).getOrDefault("a", "c", 0)).toEqual(0);
    });

    it("should getOrCreate()", () => {
        expect(new BiMap([["a", "b", 2], ["b", "c", 3]]).getOrCreate("a", "b", 1)).toEqual(2);
        expect(new BiMap([["a", "b", 2], ["b", "c", 3]]).getOrCreate("a", "c", 1)).toEqual(1);
        expect(new BiMap([["a", "b", 2], ["b", "c", 3]]).getOrCreate("a", "b", () => 1)).toEqual(2);
        expect(new BiMap([["a", "b", 2], ["b", "c", 3]]).getOrCreate("a", "c", () => 1)).toEqual(1);
    });
    ...
    it("should clone()", () => {
        let cln = new BiMap([["a", "b", 2], ["a", "c", 2], ["b", "c", 3], ["b", "d", 3], ["g", "f", 3]]);
    ...
    it("should have some()", () => {
        expect(new BiMap([["a", "b", 2], ["a", "d", 3]]).some((v) => v === 2)).toEqual(true);
        expect(new BiMap([["a", "b", 2], ["a", "d", 3]]).some((v) => v === 1)).toEqual(false);
    });

    it("should have every()", () => {
        expect(new BiMap([["a", "b", 2], ["a", "d", 3]]).every((v, k1) => k1 === "a")).toEqual(true);
        expect(new BiMap([["a", "b", 2], ["a", "c", 3]]).every((v, k1, k2) => k2 === "b")).toEqual(false);
    });
